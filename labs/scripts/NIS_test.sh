...
# - client's server is server.b4?
# - server: server is running?
# - Dummykonto skapas på servern - minimala rättigheter?
# - Inloggning på dummykonto på annan klient (företrädesvis automatiskt, ev. manuellt)
# - inloggning på dummykonto lokalt före nis (skapa lokalt)
